    ...
    <main className="relative min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <AuroraBackground>
        ...
        >
          ...
          <div className="mt-6">
            <a
              href="#contact"
              className="inline-block px-4 py-3 text-white font-bold text-lg rounded-xl border-1 border-purple-500 hover:bg-purple-500 hover:text-black transition-all duration-300 ease-in-out"
            >
              Contact Us
            </a>
          </div>
      ...
      <section id="trusted" className="py-16 bg-black text-white overflow-hidden relative">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-4xl font-bold mb-8">Trusted by Clients Worldwide</h2>
                ...
                [
                  ...
                  >
                    <Image
                      ...
                      width={128}
                      height={80}
                      className="object-contain opacity-80 hover:opacity-100 grayscale hover:grayscale-0 transition"
                    />
                  </div>
                ))
              )}
      ...
      <BackgroundBeamsWithCollision className="text-white">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-purple-700 font-bold text-xl md:text-2xl mb-2">The</h2>
